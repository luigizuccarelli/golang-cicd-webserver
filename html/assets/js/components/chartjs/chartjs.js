(function ($) {
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderWidth: 3,
                data: [116, 115, 117, 120, 117, 120, 118]
            }]
        },
        options: {
			legend: {
    ...
    var ctx = document.getElementById('line-chart-03').getContext("2d");
    ...
    var ctx = document.getElementById('line-chart-04').getContext("2d");
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: "transparent",
                borderWidth: 3,
                data: [36.3, 36.5, 36.8, 36.1, 36.5, 36.7, 39.5]
            }]
        },
        options: {
			legend: {
    ...
    var ctx = document.getElementById('line-chart-05').getContext("2d");
