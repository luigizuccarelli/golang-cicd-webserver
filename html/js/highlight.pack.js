...
},e.C_BLOCK_COMMENT_MODE,t,e.HASH_COMMENT_MODE]}}}());hljs.registerLanguage("properties",function(){"use strict";return function(e){
...
},{className:"string",begin:/'/,end:/'/},s]}}}());hljs.registerLanguage("coffeescript",function(){"use strict"
...
end:/$/,keywords:{$pattern:/[\.\w]+/,"meta-keyword":".PHONY"}},s]}}}());hljs.registerLanguage("go",function(){"use strict";return function(e){var n={
...
end:"$"}]}}}());hljs.registerLanguage("c-like",function(){"use strict";return function(e){
